...
def build_onboarding_modal(
    *,
    ...
    return {
        ...
        "blocks": [
            _plain_input("display_name", "Organization name", "Example Financial Group"),
            _plain_input("sectors", "Sectors", "financial services, healthcare"),
            _plain_input("products", "Products or systems", "Credit model, support chatbot"),
            _plain_input(
                "business_model",
                "Business profile",
                "Enterprise handling regulated customer, employee, or operational data.",
                multiline=True,
            ),
            _plain_input("jurisdictions", "Jurisdictions", "United States, European Union"),
            {
                "type": "input",
            ...
            _plain_input(
                ...
                "New regulatory obligations affecting customer data controls",
            ),
